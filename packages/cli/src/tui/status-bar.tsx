...
export const StatusBar = memo(function StatusBar({ contextTokens, contextLimit, running, questionPending, thinkingAvailable, scrolled, cacheInputTokens, missInputTokens, outputTokens }: StatusBarProps) {
  ...
  else if (scrolled) hints = "↑↓ scroll · home top · end follow";
