...
const TOOL_USE_PROMPT = [
  ...
  "- For file operations (read/write/edit/glob/grep) and fetching URLs, use the dedicated tool. Only fall back to Shell when no dedicated tool exists for the task.",
